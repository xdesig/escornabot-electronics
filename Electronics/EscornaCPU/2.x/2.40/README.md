...
## Escorna CPU 2.4
 It is a pcb that integrates an ATmega328P, a step-up (to use 1.2V batteries) and the rest of the electronics needed to build an Escornabot.<br> (The idea of integrating a step-up into the PCB is the rafa couto)<br>
